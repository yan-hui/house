                                ...
                                <div class="sorting">
                                    <div class="form-group">
                                        <select name="sorting" id="sorting">
                                            ...
                                            <option value="price_asc" <#if (vo.sort) == "price_asc">   selected </#if> >
                                                价格由低到高
                                            </option>
                                            <option value="price_desc" <#if (vo.sort) == "price_desc">  selected </#if> >
                                                价格由高到低
                                            </option>
                                            <option value="time_desc" <#if (vo.sort) == "time_desc">   selected </#if> >
                                                加入时间
                                            </option>
                                        </select>
                                    </div><!-- /.form-group -->
